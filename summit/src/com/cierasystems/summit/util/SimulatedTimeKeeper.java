...
import com.cierasystems.summit.application.ApplicationTask;
...
public class SimulatedTimeKeeper implements TimeKeeper {
    ...
    private void addTimer( Timer timer ) {
        ...
        if ( !taskInQueue.get() ) {
            Application.app.getExecutor().execute( new PopTimerTask() );
            taskInQueue.set( true );
        }
    }
    
    private class PopTimerTask extends ApplicationTask {
        @Override
