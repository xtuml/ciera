        ...
        displayThread = new Thread() {
            ...
            public void run() {
                ...
                do {
                    ...
                    for ( i = 0; i < 50; i++ ) progressBar[i] = ( percentage >= (i + 1) * 2 ) ? '=' : ' ';
                    if ( percentage > lastPercentage ) {
                        i = 0;
                        System.err.printf( "[%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c] %3d%% %d/%d.%c", 
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                ...
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++], progressBar[i++],
                                percentage, done, ProgressBar.this.count, lineEnder );
                    }
