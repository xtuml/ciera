...
public class MagnetronTubeSet extends InstanceSet {
    ...
    // empty set
    public static final MagnetronTubeSet emptyMagnetronTubeSet = new EmptyMagnetronTubeSet();

    // selections
    public OvenSet selectManyMO_OsOnR1() throws XtumlException {
        return selectManyMO_OsOnR1( null );
    }

    public OvenSet selectManyMO_OsOnR1( Where condition ) throws XtumlException {
