...
T_b("\n");
T_b("    ");
T_b("public MicrowaveOvenApplication() {");
T_b("\n");
T_b("        ");
...
T_b("\n");
T_b("            ");
T_b("component.getRunContext().execute( new Runnable() {");
T_b("\n");
T_b("                ");
T_b("@Override");
T_b("\n");
...
T_b("\n");
T_b("                        ");
T_b("component.getRunContext().getExceptionHandler().handle( e );");
T_b("\n");
T_b("                    ");
T_b("}");
T_b("\n");
...
T_b("\n");
T_b("        ");
T_b("if ( executors.length > 0 ) {");
T_b("\n");
T_b("            ");
T_b("if ( executors.length > 1 ) {");
T_b("\n");
T_b("                ");
T_b("for ( int i = 1; i < executors.length; i++ ) {");
T_b("\n");
T_b("                    ");
T_b("new Thread( executors[i] ).start();");
T_b("\n");
T_b("                ");
T_b("}");
T_b("\n");
