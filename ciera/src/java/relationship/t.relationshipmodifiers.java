...
T_b("\n");
T_b("        ");
T_b("else new ModelIntegrityException( \"Instances could not be related.\" );");
T_b("\n");
T_b("    ");
T_b("}");
T_b("\n");
...
T_b("_extent.remove( ");
T_b(self->name);
T_b("_extent.get( form.getInstanceId(), part.getInstanceId() ) ) ) new ModelIntegrityException( \"Instances could not be unrelated.\" );");
T_b("\n");
T_b("    ");
T_b("}");
T_b("\n");
