.if ( isset )
  .if ( not isempty )
    ...
    public synchronized ${target_type_name} selectMany${target_key_letters}sOnR${rel_numb}${phrase}( IWhere condition ) throws XtumlException {
...
.else
  .if ( isempty )
    .if ( is_many )
    @Override
    public synchronized ${target_type_obj_name} selectAny${target_key_letters}OnR${rel_numb}${phrase}( IWhere condition ) throws XtumlException {
    ...
    .else
    @Override
    public synchronized ${target_type_name} selectOne${target_key_letters}OnR${rel_numb}${phrase}( IWhere condition ) throws XtumlException {
