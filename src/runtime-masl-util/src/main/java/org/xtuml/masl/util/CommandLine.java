...
public class CommandLine {
    ...
    public static enum Conditionality {
        ...
        private io.ciera.runtime.application.CommandLine.Conditionality toRuntime() {
            return this == Optional ? io.ciera.runtime.application.CommandLine.Conditionality.Optional
    ...
    public static enum Multiplicity {
        ...
        private io.ciera.runtime.application.CommandLine.Multiplicity toRuntime() {
            return this == Single ? io.ciera.runtime.application.CommandLine.Multiplicity.Single
    ...
    public void register_value(final String option, final String usage_text, final Conditionality option_type,
        ...
        cmd.registerValue(option, usage_text, option_type.toRuntime(), value_name, value_type.toRuntime(),
    ...
    public String get_command() {
        return Application.getInstance().getName() + " " + Stream.of(cmd.getArgs()).collect(Collectors.joining(" "));
    }
