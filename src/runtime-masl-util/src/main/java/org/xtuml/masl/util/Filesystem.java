...
public class Filesystem {
    ...
    public static enum File_Types {
        Socket, Symlink, File, Block, Directory, Character, FIFO;
    }
    ...
    public static class File_Status implements Serializable {
        ...
        public String toString() {
            return super.toString() + " (" + "file_type=" + getFile_type() + ", permissions=" + getPermissions()
                    + ", uid=" + getUid() + ", gid=" + getGid() + ", size=" + getSize() + ", access_time="
    ...
    public static class Filesystem_Status implements Serializable {
        ...
        @Override
        public String toString() {
            return super.toString() + " (" + "total_bytes=" + getTotal_bytes() + ", free_bytes=" + getFree_bytes()
                    + ", available_bytes=" + getAvailable_bytes() + ", total_nodes=" + getTotal_nodes()
                    + ", free_nodes=" + getFree_nodes() + ", available_nodes=" + getAvailable_nodes()
                    + ", max_filename_length=" + getMax_filename_length() + ", read_only=" + getRead_only() + ")";
        }
