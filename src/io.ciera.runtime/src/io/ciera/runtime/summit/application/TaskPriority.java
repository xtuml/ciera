...
public final class TaskPriority {
    ...
    public static final int HALT_EXECUTION_PRIORITY = 0x00;
    ...
    public static final int GENERIC_EXECUTION_PRIORITY = 0x12;
    public static final int TIMER_EXPIRED_PRIORITY = 0x13;
