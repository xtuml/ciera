package io.ciera.tool.templateengine.architecture.interfaces.impl;
...
import io.ciera.tool.templateengine.architecture.component.ComponentDefinition;
import io.ciera.tool.templateengine.architecture.component.impl.ComponentDefinitionImpl;
...
import io.ciera.tool.templateengine.architecture.interfaces.Iface;
import io.ciera.tool.templateengine.architecture.interfaces.Message;
import io.ciera.tool.templateengine.architecture.interfaces.MessageSet;
import io.ciera.tool.templateengine.architecture.interfaces.Port;
import io.ciera.tool.templateengine.architecture.interfaces.PortMessage;
import io.ciera.tool.templateengine.architecture.interfaces.PortMessageSet;
import io.ciera.tool.templateengine.architecture.interfaces.impl.IfaceImpl;
import io.ciera.tool.templateengine.architecture.interfaces.impl.PortImpl;
import io.ciera.tool.templateengine.architecture.interfaces.impl.PortMessageSetImpl;
import io.ciera.tool.templateengine.ooaofmarking.Mark;
import io.ciera.tool.templateengine.ooaofooa.component.C_C;
import io.ciera.tool.templateengine.ooaofooa.component.C_PO;
import io.ciera.tool.templateengine.ooaofooa.component.impl.C_POImpl;
import io.ciera.tool.templateengine.ooaofooa.packageableelement.PackageableElement;
...
public class PortImpl extends ModelInstance<Port,TemplateEngine> implements Port {
    ...
    // constructors
    private PortImpl( TemplateEngine context ) {
    ...
    private PortImpl( TemplateEngine context, UniqueId instanceId, String ref_name, String ref_package, String m_port_name, boolean m_provider, String ref_comp_name, String ref_comp_package, String ref_iface_name, String ref_iface_package, String ref_provider_port_name, String ref_provider_port_package, String m_base_class, UniqueId ref_port_Id ) {
        super(instanceId);
        this.context = context;
    ...
    public static Port create( TemplateEngine context ) throws XtumlException {
    ...
    public static Port create( TemplateEngine context, UniqueId instanceId, String ref_name, String ref_package, String m_port_name, boolean m_provider, String ref_comp_name, String ref_comp_package, String ref_iface_name, String ref_iface_package, String ref_provider_port_name, String ref_provider_port_package, String m_base_class, UniqueId ref_port_Id ) throws XtumlException {
...
class EmptyPort extends ModelInstance<Port,TemplateEngine> implements Port {
