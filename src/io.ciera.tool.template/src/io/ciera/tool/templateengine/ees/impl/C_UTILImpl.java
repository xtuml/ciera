package io.ciera.tool.templateengine.ees.impl;
...
import io.ciera.tool.templateengine.ees.C_UTIL;
...
public class C_UTILImpl<C extends IComponent<C>> extends Utility<C> implements C_UTIL {
    ...
    public String organizeImports( final String p_s ) {
        ...
        for ( String line : lines ) {
            ...
            if ( -1 == dotIndex ) dotIndex = line.indexOf(';');
    ...
    private class ImportSet extends TreeSet<String> {
        ...
        public boolean add( String e ) {
            if ( null != e && !"".equals(e.trim()) ) return super.add(e);
            else return false;
        }
    }
