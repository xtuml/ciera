...
public interface LOAD {
    ...
    /**
     * Create a new loader with a given set of arguments and kick off the loading
     * process. An instance of the class specified by the {@code java_class}
     * parameter is created. The specified class is expected to implement the
     * {@link io.ciera.runtime.instanceloading.generic.IGenericLoader
     * IGenericLoader} interface. Once created, the {@code load} method of the
     * loader will be invoked, passing {@code args} and an instance of the
     * {@code LOAD} class to link call back in to the instance population.
     *
     ...
     * @throws XtumlException if the class specified by {@code java_class} cannot be
     *                        loaded or if it does not implement the
     *                        {@link io.ciera.runtime.instanceloading.generic.IGenericLoader
     *                        IGenericLoader} interface or if the loader itself
     *                        throws an error
    ...
    /**
     * Kick off the loading process with the given set of arguments. The
     * {@code load} method of the loader will be invoked, passing {@code args} and
     * an instance of the {@code LOAD} class to link call back in to the instance
     * population.
     *
     * @param args the list of arguments to pass to the loader class
     * @throws XtumlException if the loader itself throws an error
     * @see io.ciera.runtime.instanceloading.generic.IGenericLoader IGenericLoader
     */
     ...
     *
     * @param loader the new default loader
     * @see io.ciera.runtime.instanceloading.generic.IGenericLoader IGenericLoader
     */
     ...
     * @throws XtumlException if no class with matching key letters can be found in
     *                        the component
     */
     ...
     *                relationships
     * @throws XtumlException if the relationship specified does not exist between
     *                        inst1 and inst2 or if the act of relating the
     *                        instances results in a model integrity violation
     */
     ...
     * inst2} are interchangeable and the value of {@code phrase} has no effect. It
     * may be {@code null}. For reflexive relationships, {@code inst1} and
     ...
     * @throws XtumlException if the specified attribute does not exist on the class
     *                        or if the type of the passed value is not compatible
     ...
     * @return The result of the function invocation or {@code null} for functions
     *         with void return type
     * @throws XtumlException if the a domain function could not be found with the
     *                        given names, or if the number of arguments or types of
     *                        arguments mismatch
     */
