...
/**
 * An instance action home represents an action home which provides a refence to an associated
...
public interface InstanceActionHome extends ActionHome {
   ...
   *
   * @return {@link ObjectInstance} the object instance bound to execution of this action.
   */
